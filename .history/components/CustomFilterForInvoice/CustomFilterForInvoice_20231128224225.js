...
import { getInvoiceFilter } from "../../store/invoice/asyncAction";
import { getAllInvoiceSerialNumberLists } from "../../store/invoiceSerialNumberList/asyncAction";

const CustomFilterForInvoice = ({ data, setInvoicesByNMId, currentPage, listNhaMays }) => {
    ...
    const [selectedSoHopDong, setSelectedSoHopDong] = useState(null);
    const [selectedSoHoaDon, setSelectedSoHoaDon] = useState(null);
    const [selectedTu, setSelectedTu] = useState(null);
    const [selectedDen, setSelectedDen] = useState(null);
    const [selectedSdt, setSelectedSdt] = useState(null);
    ...
    const [invoiceSerialNumberLists, setInvoiceSerialNumberLists] = useState([])
  ...
  `;
    ...
    const handleFilterHoaDon = async () => {
        dispatch(
            ...
            keyIdHopDong: selectedSoHopDong,
            tenKhachHang: selectedKhachHang,
            soDienThoaiKhachHang: selectedSdt,
            seriHoaDon: selectedSoHoaDon,
            tu: selectedTu,
            den: selectedDen,
            trangThaiHoaDon: selectedTrangThai
        })).then((result) => {
            if (result.payload) {
              console.log("Filtered invoice:", result.payload);
              const data = result.payload;
              setInvoicesByNMId(data);
            } else {
    ...
    useEffect(() => {
        dispatch(getAllInvoiceSerialNumberLists()).then((result) => {
            if (result.payload) {
                console.log("Danh muc seri Hoa don:", result.payload);
                const data = result.payload;
                setInvoiceSerialNumberLists(data)
            } else {
                console.log("No data returned");
            }
        })
            ...
            >
                ...
                <FormControl mt="3" style={styles.formControl}>
                    ...
                    <Select
                        ...
                        mt={1}
                        onValueChange={(itemValue) => selectedCanBo(itemValue)}
                    >
                ...
                <FormControl mt="3" style={styles.formControl}>
                    ...
                    <AutocompleteDropdown
                        ...
                        onSelectItem={item => setSelectedTuyenDoc(item.keyId)}
                        onChangeText={(value) => {
                ...
                <FormControl mt="3" style={styles.formControl}>
                    ...
                    <AutocompleteDropdown
                        ...
                        onSelectItem={item => setSelectedSoHopDong(item.keyId)}
                        onChangeText={(value) => {
                ...
                <FormControl mt="3" style={styles.formControl}>
                    ...
                    <Select
                        selectedValue={selectedSoHoaDon}
                        minWidth="200"
                        accessibilityLabel="Chọn số hóa đơn"
                        ...
                        mt={1}
                        onValueChange={(itemValue) => setSelectedSoHoaDon(itemValue)}
                    >
                        {invoiceSerialNumberLists?.map((item) => (
                            <Select.Item
                                key={item.id}
                                label={item.soHoaDon}
                                value={item.soHoaDon}
                ...
                <FormControl mt="3" style={styles.formControl}>
                    ...
                    <Select
                        ...
                        mt={1}
                        onValueChange={(itemValue) => setSelectedTu(itemValue)}
                    >
                ...
                <FormControl mt="3" style={styles.formControl}>
                    ...
                    <Select
                        ...
                        mt={1}
                        onValueChange={(itemValue) => setSelectedDen(itemValue)}
                    >
                        <Select.Item key={"1"} label="Tháng 1" value="1" />
                        <Select.Item key={"2"} label="Tháng 2" value="2" />
                        <Select.Item key={"3"} label="Tháng 3" value="3" />
                ...
                <FormControl mt="3" style={styles.formControl}>
                    ...
                    >
                        ...
                        <Select.Item key={"2"} label="Đã thanh toán" value="2" />
                    </Select>
                </FormControl>
                <FormControl mt="3" style={styles.formControl}>
                    ...
                    <AutocompleteDropdown
                        ...
                        onSelectItem={item => setSelectedSdt(item.dienThoai)}
                        onChangeText={(value) => {
