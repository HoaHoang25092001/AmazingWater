        ...
        <View style={styles.centeredView}>
            <Modal visible={visible} animationType="slide">
                <View style={styles.modalView}>
                    ...
                    <Box maxW="300">
                        <Select selectedValue={service} minWidth="250" minHeight="45" accessibilityLabel="Choose Service" bg="white" placeholder="Loại khách hàng" _selectedItem={{
                            bg: "white",
                    ...
                    <Box maxW="300">
                        <Select selectedValue={scope} minWidth="250" minHeight="30" accessibilityLabel="Choose Service" bg="white" placeholder="Phạm vi" _selectedItem={{
                            bg: "white",
                            endIcon: <CheckIcon size="5" />
                        }} _light={{
                            bg: "white",
                    ...
                    <Box maxW="400">
                        <Select selectedValue={region} minWidth="250" minHeight="45" accessibilityLabel="Choose Service" bg="steal.600" placeholder="Vùng" _selectedItem={{
                            bg: "teal.600",
                            endIcon: <CheckIcon size="5" />
                        }} _light={{
                            bg: "coolGray.100",
                    ...
                    <Box maxW="400">
                        <Select selectedValue={area} minWidth="250" minHeight="45" accessibilityLabel="Choose Service" bg="steal.600" placeholder="Choose Service" _selectedItem={{
                            bg: "teal.600",
