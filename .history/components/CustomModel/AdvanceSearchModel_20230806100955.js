        ...
        <View style={styles.centeredView}>
            <Modal visible={visible} animationType="slide">
                <View style={styles.modalView}>
                    ...
                    <Text >Phạm vi</Text>
                    <Box maxW="300">
                        <Select selectedValue={scope} minWidth="200" minHeight="45" accessibilityLabel="Choose Service" bg="steal.600" placeholder="Choose Service" _selectedItem={{
                            bg: "teal.600",
                            endIcon: <CheckIcon size="5" />
                        }} _light={{
                            bg: "coolGray.100",
                    ...
                    <Text >Vùng</Text>
                    <Box maxW="300">
                        <Select selectedValue={region} minWidth="200" minHeight="45" accessibilityLabel="Choose Service" bg="steal.600" placeholder="Choose Service" _selectedItem={{
                            bg: "teal.600",
                            endIcon: <CheckIcon size="5" />
                        }} _light={{
                            bg: "coolGray.100",
