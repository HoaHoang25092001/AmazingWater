                        ...
                        <Box w="100%" maxW="400">
                            <VStack space="md">
                                <VStack mx="4" space="md">
                                    ...
                                    <Progress colorScheme="tertiary" value={55} />
                                    <Progress colorScheme="warning" value={65} />
                                    <Progress colorScheme="info" value={75} />
                                    <Progress colorScheme="rose" value={75} />
                                    <Progress colorScheme="fuchsia" value={75} />
                                    <Progress colorScheme="indigo" value={75} />
                                    <Progress colorScheme="lightBlue" value={75} />
                                    <Progress colorScheme="teal" value={75} />
                                </VStack>
                            </VStack>
                        </Box>
                    </View>
