...
const EditInvoiceModel = ({ visible, onClose }) => {
    ...
    const [customerHouseHoldNumber, setCustomerHouseHoldNumber] = useState("");
    const [customerfamilySize, setCustomerfamilySize] = useState("");
  ...
  `;
    ...
    const { invoiceForUpdate } = useSelector(state => state.invoice)
    console.log("Hoa don by Id", invoiceForUpdate)

    useEffect(() => {
        if (invoiceForUpdate) {
            setCustomerNameField(invoiceForUpdate.tenKH);
            setCustomerIdField(invoiceForUpdate.khachHangKeyId);
            setCustomerTaxCodeField(invoiceForUpdate.maSoThue);
            setCustomerPhoneNumberField(invoiceForUpdate.dienThoai);
            setCustomerAddressField(invoiceForUpdate.diaChi);
            setCustomerHouseHoldNumber(invoiceForUpdate.soHo);
            setCustomerfamilySize(invoiceForUpdate.soKhau);
            setCustomerBankName(invoiceForUpdate.tenNganHang);
            setCustomerBankAccount(invoiceForUpdate.taiKhoanNH);
            setCustomerBankAccountName(invoiceForUpdate.tenTaiKhoan);
        }
    }, [invoiceForUpdate]);
                                ...
                                >
                                    <Box w="95%" maxW="400" alignItems="center">
                                        <VStack space="md">
                                            ...
                                            <Box maxW="100%" alignItems="center">
                                                <Input mx="3" placeholder="Số hộ" value={customerHouseHoldNumber} w="100%" />
                                            </Box>
                                            <Text fontFamily="Quicksand_500Medium">Số khẩu:</Text>
                                            <Box maxW="100%" alignItems="center">
                                                <Input mx="3" placeholder="Số khẩu" value={customerfamilySize} w="100%" />
                                            </Box>
                                            <Text fontFamily="Quicksand_500Medium">Tên ngân hàng:</Text>
                                            <Box maxW="100%" alignItems="center">
                                                <Input mx="3" placeholder="Tên ngân hàng" value={customerBankName} w="100%" />
                                            </Box>
                                            <Text fontFamily="Quicksand_500Medium">Tài khoản ngân hàng:</Text>
                                            <Box maxW="100%" alignItems="center">
                                                <Input mx="3" placeholder="Tài khoản hàng" value={customerBankAccount} w="100%" />
                                            </Box>
                                            <Text fontFamily="Quicksand_500Medium">Tên tài khoản:</Text>
                                            <Box maxW="100%" alignItems="center">
                                                <Input mx="3" placeholder="Tên tài khoản" value={customerBankAccountName} w="100%" />
                                            </Box>
                                            <Text fontFamily="Quicksand_500Medium">Ghi chú:</Text>
                                            <TextArea
                                                fontFamily="Quicksand_500Medium"
