                    ...
                    <Box alignItems="center" w="100%">
                        <Box w="90%" maxW="400">
                            <VStack space="md">
                                ...
                                <Input mx="3" variant="filled" placeholder="Tuyến đọc" w="100%" value={invoice.chiSoDongHo.tuyenId} isDisabled/>
                                </Box>
                                <Text fontFamily="Quicksand_500Medium">Khách hàng:</Text>
                                <Box maxW="100%" alignItems="center">
                                    <Input mx="3" variant="filled" placeholder="Tên khách hàng" w="100%" value={invoice.tenKhachHang} isDisabled/>
                                </Box>
