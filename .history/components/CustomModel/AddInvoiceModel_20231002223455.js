                                ...
                                >
                                    <Box w="95%" maxW="400" alignItems="center">
                                        <VStack space="md">
                                            ...
                                            <Text fontFamily="Quicksand_500Medium">Số đồng hồ:</Text>
                                            <Box maxW="100%" alignItems="center">
                                                <Input mx="3" placeholder="số đồng hồ" w="100%" />
                                            </Box>
                                            <Text fontFamily="Quicksand_500Medium">Mã hợp dồng:</Text>
                                            <Box maxW="100%" alignItems="center">
                                                <Input mx="3" placeholder="Mã hợp đồng" w="100%" />
                                            </Box>
