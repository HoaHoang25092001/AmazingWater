                ...
                <View style={styles.modalView}>
                    ...
                    <View style={{ minHeight: 200, width: 280 }}>
                        <View style={{ marginBottom: 15, flexDirection: 'row', justifyContent: "center", alignItems: "center" }}>
                            <Progress.Bar progress={0.1} width={250} height={8} color='red' borderWidth={0.5} />
                            <Progress colorScheme="primary" value={35} />
                            <Text style={{ marginLeft: 15 }}>100</Text>
                        </View>
                        <View style={{ marginBottom: 15, flexDirection: 'row', justifyContent: "center", alignItems: "center" }}>
                            <Progress.Bar progress={0.2} width={250} height={8} color='orange' borderWidth={0.5} />
                            <Text style={{ marginLeft: 15 }}>200</Text>
                        </View>
                        <View style={{ marginBottom: 15, flexDirection: 'row', justifyContent: "center", alignItems: "center" }}>
                            <Progress.Bar progress={0.3} width={250} height={8} color='yellow' borderWidth={0.5} />
                            <Text style={{ marginLeft: 15 }}>300</Text>
                        </View>
                        <View style={{ marginBottom: 15, flexDirection: 'row', justifyContent: "center", alignItems: "center" }}>
                            <Progress.Bar progress={0.4} width={250} height={8} color='green' borderWidth={0.5} />
                            <Text style={{ marginLeft: 15 }}>400</Text>
                        </View>
                        <View style={{ marginBottom: 15, flexDirection: 'row', justifyContent: "center", alignItems: "center" }}>
                            <Progress.Bar progress={0.5} width={250} height={8} color='blue' borderWidth={0.5} />
                            <Text style={{ marginLeft: 15 }}>500</Text>
                        </View>
                        <View style={{ marginBottom: 15, flexDirection: 'row', justifyContent: "center", alignItems: "center" }}>
                            <Progress.Bar progress={0.6} width={250} height={8} color='indigo' borderWidth={0.5} />
                            <Text style={{ marginLeft: 15 }}>600</Text>
                        </View>
                        <View style={{ marginBottom: 15, flexDirection: 'row', justifyContent: "center", alignItems: "center" }}>
                            <Progress.Bar progress={0.7} width={250} height={8} color='violet' borderWidth={0.5} />
                            <Text style={{ marginLeft: 15 }}>700</Text>
                        </View>
                        <View style={{ marginBottom: 15, flexDirection: 'row', justifyContent: "center", alignItems: "center" }}>
                            <Progress.Bar progress={0.8} width={250} height={8} color='pink' borderWidth={0.5} />
                            <Text style={{ marginLeft: 15 }}>800</Text>
                        </View>
                        <View style={{ marginBottom: 15, flexDirection: 'row', justifyContent: "center", alignItems: "center" }}>
                            <Progress.Bar progress={0.9} width={250} height={8} color='purple' borderWidth={0.5} />
