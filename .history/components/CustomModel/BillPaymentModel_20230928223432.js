...
import { Box, CheckIcon, Select, Modal, FormControl, VStack, HStack, Button, Icon, Text, Input } from 'native-base';
                        ...
                        <Box w="90%" maxW="400">
                            ...
                            <Text fontFamily="Quicksand_500Medium">Tháng:</Text>
                                ...
                                <Box maxW="100%" alignItems="center">
                                    <Input mx="3" placeholder="Khách hàng" w="100%" />
                                </Box>
                                <Text fontFamily="Quicksand_500Medium">Số hợp đồng:</Text>
                                <Box maxW="100%" alignItems="center">
                                    <Input mx="3" placeholder="Số hợp đồng" w="100%" />
                                </Box>
                            </VStack>
                        </Box>
                    </Box>
