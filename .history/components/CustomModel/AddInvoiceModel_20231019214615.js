                                ...
                                >
                                    <Box w="95%" maxW="400">
                                        <VStack space="md">
                                            <Text fontFamily="Quicksand_500Medium">Mã khách hàng:</Text>
                                            <Box maxW="100%" alignItems="center">
                                                <Input mx="3" placeholder="Mã khách hàng" w="100%" value='NM_HH_so1002215'/>
                                            </Box>
                                            <Text fontFamily="Quicksand_500Medium">Tên KH:</Text>
                                            <Box maxW="100%" alignItems="center">
                                                <Input mx="3" placeholder="Tên khách hàng" w="100%" value='Nguyễn Văn Sơn - Hiền'/>
                                            </Box>
                                            <Text fontFamily="Quicksand_500Medium">Mã số thuế:</Text>
                                            <Box maxW="100%" alignItems="center">
                                                <Input mx="3" placeholder="Mã số thuế" w="100%" />
                                            </Box>
                                            <Text fontFamily="Quicksand_500Medium">Điện thoại:</Text>
                                            <Box maxW="100%" alignItems="center">
                                                <Input mx="3" placeholder="Số điện thoại" w="100%" />
                                            </Box>
                                            <Text fontFamily="Quicksand_500Medium">Địa chỉ:</Text>
                                            <Box maxW="100%" alignItems="center">
                                                <Input mx="3" placeholder="Địa chỉ" w="100%" value='Thôn Chùa - Lương Phong - Hiệp Hòa - Bắc Giang'/>
                                            </Box>
                                            <Text fontFamily="Quicksand_500Medium">Số hộ:</Text>
                                            <Box maxW="100%" alignItems="center">
                                                <Input mx="3" placeholder="Sổ hộ" w="100%" />
                                            </Box>
                                            <Text fontFamily="Quicksand_500Medium">Số khẩu:</Text>
                                            <Box maxW="100%" alignItems="center">
                                                <Input mx="3" placeholder="Số khẩu" w="100%" />
                                            </Box>
                                            <Text fontFamily="Quicksand_500Medium">Tên NH:</Text>
                                            <Box maxW="100%" alignItems="center">
                                                <Input mx="3" placeholder="Tên ngân hàng" w="100%" />
                                            </Box>
                                            <Text fontFamily="Quicksand_500Medium">Tài khoản NH:</Text>
                                            <Box maxW="100%" alignItems="center">
                                                <Input mx="3" placeholder="Tài khoản ngân hàng" w="100%" />
                                            </Box>
                            ...
                            <VStack space="md">
                                ...
                                >
                                    <Box w="95%" maxW="400" alignItems="center">
                                        <VStack space="md">
                                            <Text fontFamily="Quicksand_500Medium">Kỳ ghi chỉ số:</Text>
                                            <Box maxW="100%" alignItems="center">
                                                <Input mx="3" placeholder="Kỳ ghi chỉ số" w="100%" />
                                            </Box>
                                            <Text fontFamily="Quicksand_500Medium">Số hóa đơn:</Text>
                                            <Box maxW="100%" alignItems="center">
                                                <Input mx="3" placeholder="Số hóa đơn" w="100%" value='4feee019-3786-4a6a-b9b7-6b70b5b36ebb'/>
                                            </Box>
                                            <Text fontFamily="Quicksand_500Medium">Trạng thái đọc:</Text>
                                            <Box maxW="100%" alignItems="center">
                                                <Input mx="3" placeholder="Trạng thái đọc" w="100%" />
                                            </Box>
