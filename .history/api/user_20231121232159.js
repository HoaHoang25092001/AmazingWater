...
export const filterHoaDonApi = async (filterParams) => {
  try {
    const response = await axios.get(
      `${API_URL}/api/hoa-don/filter?ThangTaoHoaDon=11%2F2023&invoiceParameter.PageNumber=1&invoiceParameter.PageSize=10&NhaMayIds=31b9862347e14cd884f15e27b3fc0ffa`,
      filterParams
    );
    console.log("Filtered data", response.data);
    return response.data;
