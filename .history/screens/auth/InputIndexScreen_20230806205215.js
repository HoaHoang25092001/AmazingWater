            ...
            <Popover.Content accessibilityLabel="Delete Customerd" w="48" pb={4} pr={4} borderBottomColor={colors.white} borderBottomWidth="0">
              <Popover.Body>
                <View style={styles.buttonContainer}>
                  <CustomButton text={"Tìm kiếm"} color={colors.blue_700} icon="search" onPress={() => setShowAdvanceSearchModel(true)} />
                  <CustomButton text={"Nhập excel"} color={colors.orange_400} icon="document-text-outline" />
                  <CustomButton text={"Nhập tệp"} color={colors.emerald_300} icon="share-outline" />
                  <CustomButton text={"Tiện ích"} color={colors.danger_500} icon="ellipsis-vertical" />
                  <CustomButton text={"Bảng giá"} color={colors.indigo_400} icon="calendar-outline" />
                  <CustomButton text={"Xem TH SD"} color={colors.blue_400} icon="time-outline" />
                  <CustomButton text={"Xem biểu đồ"} color={colors.lightBlue_300} icon="trending-up" />
                  <CustomButton text={"Xem hình ảnh"} color={colors.amber_500} icon="images" />
                  <CustomButton text={"Trạng thái"} color={colors.orange_300} icon="bar-chart-sharp" />
                </View>
              </Popover.Body>
            </Popover.Content>
          </Popover>
...
<View> <AdvanceSearchModel visible={showAdvanceSearchModel} onClose={() => setShowAdvanceSearchModel(false)} /></View>
