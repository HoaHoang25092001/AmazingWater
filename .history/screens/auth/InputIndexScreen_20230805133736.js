      ...
      <View style={styles.container}>
        ...
        <View style={styles.touchableOpacityContainer}>
          <Popover trigger={triggerProps => {
            ...
            <Popover.Content accessibilityLabel="Delete Customerd" w="48" pb={4} pr={4} borderBottomColor={colors.white}>
              <Popover.Body>
                <View style={styles.buttonContainer}>
                  <CustomButton text={"Tìm kiếm"} color={colors.blue} icon="search"/>
                  <CustomButton text={"Nhập excel"} color={colors.orange} icon="document-text-outline"/>
                  <CustomButton text={"Nhập tệp"} color={colors.green_light} icon="share-outline"/>
                  <CustomButton text={"Tiện ích"} color={colors.red} icon="ellipsis-vertical"/>
                  <CustomButton text={"Bảng giá"} color={colors.purple_light} icon="calendar-outline"/>
                  <CustomButton text={"Xem TH SD"} color={colors.sky_blue_light} icon="time-outline"/>
                  <CustomButton text={"Xem biểu đồ"} color={colors.sky_blue_light} icon="trending-up"/>
                  <CustomButton text={"Xem hình ảnh"} color={colors.orange_medium} icon="images"/>
                  <CustomButton text={"Trạng thái"} color={colors.orange_light} icon="bar-chart-sharp"/>
                </View>
              </Popover.Body>
            </Popover.Content>
          </Popover>
