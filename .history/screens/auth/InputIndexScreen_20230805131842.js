            ...
            <Popover.Content accessibilityLabel="Delete Customerd" w="48" pb={4} pr={4}>
              <Popover.Body>
                <View style={styles.buttonContainer}>
                  <CustomButton text={"Tìm kiếm"} color={colors.white} icon="search"/>
                  <CustomButton text={"Nhập excel"} color={colors.white} icon="document-text-outline"/>
                  <CustomButton text={"Nhập tệp"} color={colors.white} icon="share-outline"/>
                  <CustomButton text={"Tiện ích"} color={colors.white} icon="ellipsis-vertical"/>
                  <CustomButton text={"Bảng giá"} color={colors.white} icon="calendar-outline"/>
                  <CustomButton text={"Xem TH SD"} color={colors.white} icon="calendar-outline"/>
                  <CustomButton text={"Xem biểu đồ"} color={colors.white} icon="calendar-outline"/>
                  <CustomButton text={"Xem hình ảnh"} color={colors.white} icon="calendar-outline"/>
                  <CustomButton text={"Trạng thái"} color={colors.white} icon="calendar-outline"/>
                </View>
              </Popover.Body>
            </Popover.Content>
          </Popover>
