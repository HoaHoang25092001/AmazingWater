...
const image = { uri: 'https://nha-may-nuoc-fe.vercel.app/static/media/bia.bc4041acd559e5dfda26.gif' }
        ...
        >
            <View style={styles.overlay}>
                ...
                <View style={styles.selectFactoryContainer}>
                    <Box maxW="300">
                        <Select selectedValue={service} minWidth="200" minHeight="40" accessibilityLabel="Choose Service" bg="steal.600" placeholder="Choose Service" _selectedItem={{
                            bg: "teal.600",
                            ...
                            <Select.Item label="Nhà máy nước sạch Hiệp Hòa 1" value="ux" color="blue.500" />
                            <Select.Item label="Nhà máy nước sạch Tây Tiến - Tiền Hà - Thải Bình" value="web" color="green.500" />
                        </Select>
                    </Box>
