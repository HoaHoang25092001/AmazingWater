            ...
            <Popover.Content accessibilityLabel="Delete Customerd" w="48" pb={4} pr={4}>
              <Popover.Body>
                <View style={styles.buttonContainer}>
                  <CustomButton text={"Tìm kiếm"} color={colors.warning} icon="search"/>
                  ...
                  <CustomButton text={"Xem hình ảnh"} color={colors.white} icon="images"/>
                  <CustomButton text={"Trạng thái"} color={colors.white} icon="bar-chart-sharp"/>
                </View>
              </Popover.Body>
            </Popover.Content>
          </Popover>
