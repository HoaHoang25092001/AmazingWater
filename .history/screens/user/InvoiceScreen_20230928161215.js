        ...
        return (
            <View style={styles.container}>
                ...
                <Box w="95%" h="70%" alignItems="center">
                    ...
                    >
                        <CustomButtonInvoice text={"Tính tiền"} color={colors.moccasin} icon="calculator-outline" onPress={() => { setShowAdvanceSearchModel(true) }} textColor={colors.orange_400}/>
                        ...
                        <CustomButtonInvoice text={"Sửa hóa đơn"} color={colors.blue_400} icon="add-circle-outline" onPress={() => { setShowAdvanceSearchModel(true) }} textColor={colors.white}/>
                    </Menu>
                </Box>
            </View>
        )
