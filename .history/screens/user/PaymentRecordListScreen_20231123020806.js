...
import { getAllSoThanhToanBySoDoc } from "../../store/invoice/asyncAction";
...
function PaymentRecordListScreen({ route, navigation }) {
    ...
    const { soThanhToanBySoDoc } = useSelector(state => state.invoice)

    useEffect(() => {
        dispatch(getAllSoThanhToanBySoDoc())
            ...
            >
                ...
                >
                    <Text style={styles.titleItem}>
                        {data.maKhachHang}, {data.tenKhachHang}, {data.diaChi}</Text>
                    <View
                        style={{
                            width: '100%',
                            flex: 1,
