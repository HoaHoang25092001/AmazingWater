            ...
            <View style={styles.container}>
                ...
                <Box w="95%" h="70%" alignItems="center">
                    ...
                    >
                        ...
                        <CustomButtonInvoice text={"Sổ thanh toán"} color={colors.blue_400} icon="cash-outline" onPress={() => navigation.navigate('PaymentRecordListScreen')} textColor={colors.white} />
