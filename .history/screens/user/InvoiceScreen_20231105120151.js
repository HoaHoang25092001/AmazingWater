        ...
        <TouchableOpacity onPress={() => getInvoiceByDetails(item.id)}>
            <HStack h={10}>
                ...
                <Box
                    ...
                    py="2"
                >
                    <Text style={styles.textContent}>{item.chiSoDongHo.hopDongId}</Text>
                </Box>
                <Box
                    borderRightWidth={1}
                    style={styles.boxContent}
                ...
                <Box
                    ...
                    py="2"
                >
                    <Text style={styles.textContent}>{item.chiSoDongHo.tuyenId}</Text>
                </Box>
                <Box
                    borderRightWidth={1}
                    style={styles.boxContent}
    ...
    if (fontsLoaded) {
        return (
            <View style={styles.container}>
                <VStack space={2}>
                    <AccordionCustom  />
                    <TableList title={title} data={invoices} renderItem={renderItem} />
                </VStack>
                ...
                {/* Models */}
                <BillPaymentModel invoice={invoice} visible={showBillPaymentModel} onClose={() => setShowBillPaymentModel(false)} />
