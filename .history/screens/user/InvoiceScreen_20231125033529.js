...
const InvoiceScreen = ({ navigation }) => {
    ...
    const [invoicesByNMId, setInvoicesByNMId] = useState([]);
    ...
    const renderItem = ({ item, index }) => (
        <TouchableOpacity onPress={() => getInvoiceByDetails(item.items.id)}>
            <HStack h={10}>
                <Box
                    borderRightWidth={1}
                ...
                <Box
                    ...
                    py="2"
                >
                    <Text style={styles.textContent}>{item.items.maHopDong}</Text>
                </Box>
                <Box
                    borderRightWidth={1}
                    style={styles.boxContent}
                    ...
                    py="2"
                >
                    <Text style={styles.textContent}>{item.items.maDongHo}</Text>
                </Box>
                <Box
                    borderRightWidth={1}
                    style={styles.boxContent}
                    ...
                    py="2"
                >
                    <Text style={styles.textContent}>{item.items.tuyenDoc}</Text>
                </Box>
                <Box
                    borderRightWidth={1}
                    style={styles.boxContent}
                    ...
                    py="2"
                >
                    <Text style={styles.textContent}>{item.items.tenKhachHang}</Text>
                </Box>
                <Box
                    borderRightWidth={1}
                    style={styles.boxContent}
                    ...
                    py="2"
                >
                    <Text style={styles.textContent}>{item.items.dienThoai}</Text>
                </Box>
                <Box
                    borderRightWidth={1}
                    style={styles.boxContent}
                    ...
                    py="2"
                >
                    <Text style={styles.textContent}>{item.items.diaChi}</Text>
                </Box>
                <Box
                    borderRightWidth={1}
                    style={styles.boxContent}
                    ...
                    py="2"
                >
                    <Text style={styles.textContent}>{item.items.chiSoDongHo.chiSoCu}</Text>
                </Box>
                <Box
                    borderRightWidth={1}
                    style={styles.boxContent}
                    ...
                    py="2"
                >
                    <Text style={styles.textContent}>{item.items.chiSoDongHo.chiSoMoi}</Text>
                </Box>
                <Box
                    borderRightWidth={1}
                    style={styles.boxContent}
                    ...
                    py="2"
                >
                    <Text style={styles.textContent}>{item.items.tieuThu}</Text>
                </Box>
                <Box
                    borderRightWidth={1}
                    style={styles.boxContent}
                    ...
                    py="2"
                >
                    <Text style={styles.textContent}>{item.items.chiSoDongHo.tieuThu}</Text>
                </Box>
            </HStack>
        </TouchableOpacity>
    );
