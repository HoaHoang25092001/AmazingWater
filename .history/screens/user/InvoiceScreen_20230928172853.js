            ...
            <View style={styles.container}>
                ...
                <Box w="95%" h="70%" alignItems="center">
                    ...
                    >
                        ...
                        <CustomButtonInvoice text={"Tiện ích"} color={colors.blue_700} icon="settings-outline" onPress={() => { setShowAdvanceSearchModel(true) }} textColor={colors.white}/>
                        <CustomButtonInvoice text={"Chỉ số"} color={colors.orange_400} icon="bar-chart-outline" onPress={() => { setShowAdvanceSearchModel(true) }} textColor={colors.white}/>
                    </Menu>
                </Box>
                {/* Models */}
