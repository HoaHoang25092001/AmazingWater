    ...
    const renderItem = ({ item, index }) => (
        <TouchableOpacity>
            <HStack h={10}>
                ...
                {readingRoutes?.map((readingRoute, index) => (
                    <Box
                        key={index}
                        borderRightWidth={1}
                        style={styles.boxContent}
                        ...
                        py="2"
                    >
                    {readingRoute.id === item.chiSoDongHo.tuyenId ? (<Text style={styles.textContent}>{readingRoute.tenTuyen}</Text>) : (<Text style={styles.textContent}>{item.chiSoDongHo.tuyenId}</Text>)}
