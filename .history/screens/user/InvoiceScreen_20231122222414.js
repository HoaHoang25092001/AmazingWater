...
import { getAllInvoices, getInvoiceById  } from "../../store/invoice/asyncAction";
        ...
        return (
            <View style={styles.container}>
                <VStack space={2}>
                    ...
                    <TableList title={title} data={invoicesByNMId} renderItem={renderItem} />
                </VStack>
                <Box w="95%" h="70%" alignItems="center">
                    ...
                    >
                        ...
                        <CustomButtonInvoice text={"Sổ thanh toán"} color={colors.blue_400} icon="cash-outline" onPress={() => navigation.navigate('PaymentRecordListScreen', { paymentRecordID: data.id })} textColor={colors.white} />
