                    ...
                    >
                        <View>
                            ...
                            <View style={{
                                ...
                                <Ionicons name="checkbox-outline" size={20} color="limegreen" />
                                <Text style={{
                                    marginLeft: 5,
                                    color: 'limegreen',
                                    fontWeight: 'bold',
                        ...
                        >
                            <FontAwesome name="map-marker" size={26} color="yellowgreen" />
                        </View>
                    </View>
        ...
        >
            ...
            <View style={{
                ...
                <View
                    ...
                    <Text style={{ fontSize: 18, fontWeight: 'bold' }}>{paymentRecord.title}</Text>
                </View>
            </View>
            <View style={{
                width: '100%',
